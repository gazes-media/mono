...
type ReturnFetchType<T extends FetchType, V> =
    T extends "text" ? string :
    T extends "json" ? V : CheerioAPI;

export async function fetcher<V = any, T extends FetchType = "json">(url: string, type: T = "json" as T): Promise<ReturnFetchType<T, V>> {
